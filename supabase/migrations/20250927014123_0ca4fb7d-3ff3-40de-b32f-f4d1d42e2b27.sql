...
DROP POLICY IF EXISTS "Users can view their own receipts" ON public.message_read_receipts;
CREATE POLICY "Users can view their own receipts"
ON public.message_read_receipts FOR SELECT
USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own receipts" ON public.message_read_receipts;
