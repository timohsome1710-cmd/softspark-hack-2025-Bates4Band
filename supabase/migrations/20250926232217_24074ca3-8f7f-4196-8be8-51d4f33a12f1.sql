...
DROP POLICY IF EXISTS "Chat room members can view messages" ON public.messages;
DROP POLICY IF EXISTS "Chat room members can send messages" ON public.messages;
